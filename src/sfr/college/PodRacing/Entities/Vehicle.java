...
public class Vehicle extends AnimImageEntity{
    ...
    public void tick(){
        ...
        if(handler.getFOV()>=10)if(handler.getKeyManager().up&&!(drifting&&(handler.getKeyManager().left||handler.getKeyManager().right))){
        ...
        try{
            collisionHull.setLocation((int) (handler.getGameState().getMapX()-w2/(2*10)),(int) (handler.getGameState().getMapY()+h2/(10)));
        }catch(NullPointerException e){
            collisionHull = new Rectangle((int) (handler.getGameState().getMapX()-w2/(2*10)),(int) (handler.getGameState().getMapY()+h2/(10)),(int)(w2/10),(int)(w2/10));
        }
    ...
    public boolean isColliding(Rectangle rec){
        if (collisionHull.intersects(rec)){
